;***************************************************
; AUTHOR: Erin S. Catto
; adapted for CHIPcon v2 by Jacques Deschênes 2015
;***************************************************
EQU UP 2		; joystick UP
EQU LEFT 8       ; joystick LEFT
EQU RIGHT 16     ; joystick RIGHT
EQU SELECT 32    ;JOYSTICK fire button
EQU NO_KEY 255
